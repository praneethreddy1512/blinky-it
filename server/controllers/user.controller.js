...
export async function refreshToken(req,res) {
    try{
        ...
        const refreshToken = req.cookies?.refreshToken || (req.headers.authorization && req.headers.authorization.split(" ")[1]);
        if (!refreshToken){
        ...
        const verifytoken =  await jwt.verify(refreshToken,process.env.JWT_TOKEN_REFRESH)
