...
const handleDeleteSubCategory = async()=>{
    try {
        ...
        if(responseData.success){
            ...
            setOpenDeleteConfirmBox(false)    // Correct setter name!
  ...
  return (
    <section className=''>
        <div className='p-2   bg-white shadow-md flex items-center justify-between'>
            ...
            <button onClick={()=>setOpenAddSubCategory(true)} className='text-sm border border-yellow-300 hover:bg-yellow-300 px-3 py-1 rounded'>Add Sub Category</button>
        </div>
