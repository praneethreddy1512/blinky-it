  ...
  const handleDisableAddress = async (id) => {
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_URL}address/disable`,
        {
          data: {
            _id: id,
          },
    ...
    <div className="">
      <div className="bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center ">
        ...
        <button
          ...
          className="border border-yellow-400 text-yellow-400 px-3 hover:bg-yellow-400 hover:text-black py-1 rounded-full"
        >
          Add Address
        </button>
      </div>
