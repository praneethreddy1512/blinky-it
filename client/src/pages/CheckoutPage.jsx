...
const CheckoutPage = () => {
  ...
  const handleCashOnDelivery = async() => {
      try {
          const response = await axios.post(`${import.meta.env.VITE_API_URL}order/cash-on-delivery`,{
            data : {
  ...
  const handleOnlinePayment = async()=>{
    try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_API_URL}order/checkout`,{
            data : {
              list_items : cartItemsList,
              addressId : addressList[selectAddress]?._id,
              subTotalAmt : totalPrice,
