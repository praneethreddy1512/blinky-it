            ...
            <div className='hidden lg:flex items-center gap-10'>
              {
                user?._id ? (
                  <div className='relative'>
                    <div onClick={() => setOpenUserMenu(prev => !prev)} className='flex select-none items-center gap-1'>
                      <p>Account</p>
                      {
                        openUserMenu ? (
              ...
              <button className='flex items-center gap-2 bg-green-800 hover:bg-green-700 text-white px-3 py-3 rounded-md'>
