    ...
    <div>
      ...
      <div className='text-sm grid gap-1'>
        ...
        <Link onClick={handleClose} to="/dashboard/category" className='px-2 hover:bg-orange-200 py-1'>category</Link>)
         ...
         {
          isAdmin(user.role)&&(
        <Link onClick={handleClose} to="/dashboard/sub-category" className='px-2 hover:bg-orange-200 py-1'>subcategory</Link>)
        }
         {
          isAdmin(user.role)&&(
        ...
        <Link to="/dashboard/address" className='px-2 hover:bg-orange-200 py-1'>Saved Address</Link>
